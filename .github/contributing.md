# Contributing to sort-by-value

First and foremost, thank you! We appreciate that you want to contribute to sort-by-value, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for sort-by-value**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for sort-by-value:

- star the [project](https://github.com/jonschlinkert/sort-by-value)
- tweet your support for sort-by-value
...
- **version**: please note the version of sort-by-value are you using
...
[so]: http://stackoverflow.com/questions/tagged/sort-by-value